...
def porte_masque(message):
    role_masque = discord.utils.get(message.guild.roles, name=roles['masque'])
...
async def masque(ctx):
    ...
    """
    role_masque = discord.utils.get(ctx.message.guild.roles, name=roles['masque'])
